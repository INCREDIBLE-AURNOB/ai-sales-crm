...
I came across {{ company or 'your team' }} and noticed {{ insight }}. We’ve helped {{ persona }} teams save valuable time by {{ value_prop }}.

Would you be open to a quick chat next week? I’d love to share a short demo customized for {{ company or 'your context' }}.
...
def enrich_and_score(lead):
    ...
    prompt = f"""
You are an SDR assistant. Given a lead in JSON format, return a concise JSON containing these fields:  
- persona (string)  
- priority  
- missing_fields (list of keys that need filling)  
- insight (short, one-line string)  
- value_prop (short, one-line string)  
- enriched (dictionary with any missing fields filled or guessed)  
...
def simulate_replies(sent_records, n=8):
    ...
    templates = [
        "Hi, I'd like to learn more. Can we schedule a call next Tuesday?",
        "I'm out of the office until next week. Please follow up later.",
        "Not interested right now, thank you.",
        "Kindly remove me from your mailing list and unsubscribe me.",
        "Delivery failed: recipient mailbox full (bounce).",
        "Sure, let's connect — Wednesday afternoon works for me.",
        "No, thank you.",
        "Thanks, but we are all set. Reach out again next quarter."
    ]
